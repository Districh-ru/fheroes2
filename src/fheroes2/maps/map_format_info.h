...
namespace Maps::Map_Format
{
    ...
    struct CastleMetadata
    {
        ...
        // The spell index is written as a decimal number, where the tens digit indicates the spell level,
        // and the units digit (1-9) represents its position from left to right,
        // with position "0" corresponding to the Library spells (for Wizard castle).
